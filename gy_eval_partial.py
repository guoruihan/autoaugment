...
def train_child(t, p, m, load_dict=False):
    ...
    if load_dict:
        ...
        raw_optimizer.load_state_dict(torch.load('partial_eval_runs/raw_optimizer.pt'))
    model.train()
    ...
    torch.save(raw_optimizer.state_dict(), 'partial_eval_runs/raw_optimizer.pt')

load_dict = os.path.isfile('partial_eval_runs/model.pt')
if not load_dict:
    with open('partial_eval_runs/acc.csv', 'w') as f:
        pass
